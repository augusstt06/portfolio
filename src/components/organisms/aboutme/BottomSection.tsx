...
export default function BottomSection(props: Props) {
  ...
  return (
    <article
      className={`w-screen ${isTopSectionEnd ? '' : 'opacity-0'} relative lg:grid lg:grid-cols-3 row-span-2 simple-transition mt-5 lg:mt-0 space-y-3 lg:space-y-0 text-[#2e2e2e]`}
    >
      <Skills />
      <Introduce />
