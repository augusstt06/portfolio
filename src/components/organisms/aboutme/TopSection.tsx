...
export default function TopSection(props: Props) {
  ...
  return (
    <article className="w-full relative text-2xl font-bold row-span-1">
      <div className="hidden md:block top-1/3 md:left-20 xl:left-40 xxl:left-[30rem] left-8 xl:text-6xl absolute space-y-5 text-2xl md:text-5xl">
        <TypingText
      ...
      <div className="md:hidden w-full h-full col-flex justify-center items-center text-4xl text-center uppercase space-y-4">
        <p>
          A Steadily{' '}
